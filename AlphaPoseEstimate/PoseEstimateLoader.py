...
import sys
sys.path.append("AlphaPoseEstimate/SPPE")
from AlphaPoseEstimate.SPPE.src.main_fast_inference import InferenNet_fast, InferenNet_fastRes50
from AlphaPoseEstimate.SPPE.src.utils.img import crop_dets
from AlphaPoseEstimate.pPose_nms import pose_nms
from AlphaPoseEstimate.SPPE.src.utils.eval import getPrediction
